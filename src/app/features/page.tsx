    ...
    <section className="bg-white dark:bg-background py-24 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
        {pricing.map((plan) => (
          <div
            key={plan.id}
            className={`relative p-8 border rounded-2xl shadow-sm flex flex-col transition bg-white dark:bg-muted ${
              plan.recommended
          ...
          >
            ...
            <Button
              ...
              className={`mt-6 w-full ${
                plan.recommended ? 'bg-orange-500 hover:bg-orange-600 text-white' : 'border-orange-500 text-orange-500 hover:bg-orange-50 dark:hover:bg-orange-900/10'
              }`}
            >
              Get Started
            </Button>
